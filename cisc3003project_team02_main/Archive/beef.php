...
<?php
	...
	$sql = "SELECT price FROM food WHERE food_name = 'beef_burger'";
	$result = $link->query($sql);
...
<body>
	...
	<div class="main">
		<div class="wrap0">
			...
			<div class="wrap2">
				<h1 style="font-size:50px;text-align:center">Beef burger</h1>
				<span style="padding:400px"><img id="New_Lacheon_Meat_and_Scrambled_Egg_Burger" src="images/beef_burger.png"></span>
				...
				$(function()
			{
				...
				$("button").click(function(){	
					...
					if(customize_sauce.checked!=true){	
						...
						$('#New_Lacheon_Meat_and_Scrambled_Egg_Burger').attr('src',"images/beef_no_sauce.png");
					}
					if(customize_sauce.checked==true){	
						...
						document.getElementById('subtotal').innerHTML = subtotal_price  + ' mop';
						document.getElementById('total').innerHTML = total_price  + ' mop';
						$('#New_Lacheon_Meat_and_Scrambled_Egg_Burger').attr('src',"images/beef_burger.png");
					}
